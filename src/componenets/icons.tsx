...
export function IconHeading({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M6 4v16" />
      <path d="M6 4h6a4 4 0 010 8H6" />
      <path d="M6 12h7a4 4 0 010 8H6" />
    </svg>
  );
}

export function IconHook({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <circle cx="9" cy="4" r="1.4" />
      <path d="M9 5.5v9a4 4 0 008 0v-2" />
    </svg>
  );
}
...
export function IconArrow({ className = "h-3.5 w-3.5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M5 12h14" />
...
/* --- New icons for the Features & How-it-works sections --- */
...
export function IconZap({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconClick({ className = "h-6 w-6" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconFormDoc({ className = "h-7 w-7" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
/* --- New icons for the generator form pages --- */
...
export function IconLoader({ className = "h-4 w-4" }: IconProps) {
  return (
...
/* --- Generic (non-brand) platform icons for the social caption page --- */
...
export function IconMusicNote({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M15 4v11a3.5 3.5 0 11-3.5-3.5" />
      <path d="M15 4c.3 2 2 3.6 4 4" />
    </svg>
  );
}

export function IconThumbsUp({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      <path d="M7 11v9H4v-9h3z" />
      <path d="M7 11l4-7a2 2 0 012 2v4h5a2 2 0 012 2.3l-1.5 6A2 2 0 0116.6 20H9a2 2 0 01-2-2v-7z" />
    </svg>
  );
}

export function IconPlayCircle({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
...
export function IconVideo({ className = "h-5 w-5" }: IconProps) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className={className}>
      ...
      <path d="M16 10.5l5-2.7v8.4l-5-2.7" />
    </svg>
  );
}
